...
<body>
	<center>
		<a href="" id="home"><img src = "${pageContext.request.contextPath}/resources/images/Logo_w2.png" style="padding-top: 15px; padding-bottom: 15px; max-width: 100%; height: auto;"/></a>
